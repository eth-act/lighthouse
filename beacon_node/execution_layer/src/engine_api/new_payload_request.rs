...
mod test {
    ...
    use types::{
        BeaconBlock, ExecPayload, ExecutionBlockHash, ExecutionPayloadEnvelope,
    ...
    fn gloas_request_matches_execution_specs_ssz_and_tree_hash() {
        // Generated by ere-guests v0.17.0, using the execution-specs tests-zkevm@v0.8.4 schema.
        // Cover a real block plus empty and populated progressive lists, including builder requests.
        let fixtures: &[(&[u8], &str)] = &[
            (
                include_bytes!("../../tests/fixtures/new_payload_gloas/block_93354.ssz"),
                "8c3a890206a189727e151767653f846ccddbd269eb29fb0a2f97371f23a481c6",
            ),
            (
                include_bytes!("../../tests/fixtures/new_payload_gloas/populated.ssz"),
                "1e3a96403f54a092c167d2fc3493bb0127dbe1258491a3bd2486206d6cf1324a",
            ),
            (
                include_bytes!("../../tests/fixtures/new_payload_gloas/empty_lists.ssz"),
