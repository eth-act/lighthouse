...
use types::{
    ...
    EthSpec, ExecutionBlockHash, ExecutionProof, ExecutionProofId, ForkName, Hash256,
    KzgCommitment, KzgProof, MinimalEthSpec, SignedBeaconBlock, SignedBeaconBlockHeader, Slot,
};
