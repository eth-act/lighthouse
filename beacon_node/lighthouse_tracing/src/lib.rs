...
pub const SPAN_HANDLE_EXECUTION_PROOFS_BY_ROOT_REQUEST: &str =
    "handle_execution_proofs_by_root_request";
pub const SPAN_HANDLE_EXECUTION_PROOFS_BY_RANGE_REQUEST: &str =
    "handle_execution_proofs_by_range_request";
